...
const dogsDryFoodArr = [
	...
	},
	{
		...
		price: "$TBA",
		fullDesc: {
			analysis: ["Žali baltymai 23%", "Žali riebalai 13.5%", "Žalia ląsteliena 2.5%", "Žali pelenai 7%", "Omega-3 1%", "Omega-6 4.5%", "Magnesium 0.1%"],
	...
	},
	{
		...
		price: "$TBA",
		fullDesc: {
			analysis: ["Žali baltymai 28.0%", "Žali riebalai 17.0%", "Žalia ląsteliena 3.0%", "Žali pelenai 6.5%", "Omega-3 0.4%", "Omega-6 2.7%", "Moisture 10.0%", "Calcium 1.4%", "Phosphorus 1.0%", "Sodium 0.3%", "EPA (20:5 n-3) 0.05%", "DHA (22:6 n-3) 0.1%"],
